...
(setq base00-gui-fallback "#f2e5bc"
      ...
      base03-gui-fallback "#bdae93"
      base04-gui-fallback "#665c54"
      base05-gui-fallback "#504945"
      base06-gui-fallback "#3c3836"
      base07-gui-fallback "#282828"
      base08-gui-fallback "#9d0006"
      base09-gui-fallback "#af3a03"
      base0A-gui-fallback "#b57614"
      base0B-gui-fallback "#79740e"
      base0C-gui-fallback "#427b58"
      base0D-gui-fallback "#076678"
...
(setq base00-gui (get-xres "base00" base00-gui-fallback)
      ...
      base06-tty "cyan"
      base07-tty "white"
      base08-tty "brightblack"
      base09-tty "brightred"
      base0A-tty "brightgreen"
      base0B-tty "brightyellow"
      base0C-tty "brightblue"
      base0D-tty "brightpurple"
      base0E-tty "brightcyan"
...
(defun base16--get-base (element base-type)
  ...
  (cond
   ...
   ((and (symbolp element)
         (string-prefix-p "base0" (symbol-name element)))
    (eval (intern (replace-regexp-in-string "^\\(base0[0-9A-F]\\)$"
                                            (concat "\\1-" base-type)
                                            (symbol-name element)))))
   (t element)))
...
(base16--apply-specs
 ...
 (magit-diff-added                             :foreground base05 :background base0B)
 (magit-diff-removed                           :foreground base05 :background base08)
 (magit-diff-added-highlight                   :foreground base05 :background base0B)
 (magit-diff-removed-highlight                 :foreground base05 :background base08)
