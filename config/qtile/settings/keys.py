...
def make_keyboard_map(cfg) -> list[Key]:
    ...
    keys += [ # fmt: off
        ...
        Key([mod, alt], "h", lazy.layout.shrink(), desc="Shrink current window"),
        Key([mod, alt], "l", lazy.layout.grow(), desc="Expand current window"),
        Key([mod, shift], "space", lazy.window.toggle_floating(), desc="toggle floating"),
        Key([mod], "f", lazy.layout.toggle_focus_floating(),),
        Key([mod], "v", lazy.window.bring_to_front()),
        Key([mod, shift], "j", lazy.layout.shuffle_down(), desc="Move window down/forward",),
        Key([mod, shift], "k", lazy.layout.shuffle_up(), desc="Move window up/backward"),
        Key([mod], "n", lazy.layout.normalize(), desc="Reset all window sizes"),
        Key([mod], "ç", lazy.next_layout(), desc="Go to next layout"),
        Key([mod, shift], "ç", lazy.prev_layout(), desc="Go to previous layout"),
        ...
        Key([mod, shift], "f", lazy.window.toggle_fullscreen(), desc="Toggle fullscreen window",),
